...
also makes sense given moderate rise in biomass production and slow fall in 
...
smaller in all three facets due to the nature in which pacf controls for the 
...
look most similar, but the pacf plot for 
`Hydroelectric Power Consumption` does not look so drastically different.
