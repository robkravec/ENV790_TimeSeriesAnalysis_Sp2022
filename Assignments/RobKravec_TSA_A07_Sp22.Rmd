...
We don't need to include a mean term in the model because the series will
be differenced once. Including a drift term allows for small deviations
from a mean of zero, which is appropriate for a series that has only been
differenced once.
